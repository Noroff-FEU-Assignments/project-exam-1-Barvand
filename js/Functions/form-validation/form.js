...
form.addEventListener("submit", (e) => { 
    ...
    errorMessageName.innerText = errors.filter(err => err.startsWith("Name")).join(', ');
    errorMessageEmail.innerText = errors.filter(err => err.startsWith("Must")).join(', ');
    errorMessageSubject.innerText = errors.filter(err => err.startsWith("Subject")).join(', ');
    errorMessageMessage.innerText = errors.filter(err => err.startsWith("The")).join(', ');
